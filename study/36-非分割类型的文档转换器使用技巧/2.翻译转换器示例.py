...
llm = OllamaLLM(model="qwen2.5:1.5b", base_url="http://localhost:11434")  # 或 llama3

translate_prompt = PromptTemplate.from_template("""请将以下文本翻译成英文：
...
for doc in documents:
    translated = llm.invoke(translate_prompt.format(text=doc.page_content))
    print(translated)
